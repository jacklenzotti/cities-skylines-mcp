...
`place_road` / `place_building` take a prefab name (substring-matched against the
loaded prefabs) — use `list_prefabs` to discover the names available in your game,
since DLC and mods change the set.
